...
class _ProjectListPageState extends State<ProjectListPage> {
  ...
  Widget _buildStatisticsCard(ProjectController controller) {
    final projects = controller.projects;
    final aktif = projects.where((p) => p.status.toLowerCase() == 'aktif' || p.status.toLowerCase() == 'ongoing').length;
    final selesai = projects.where((p) => p.status.toLowerCase() == 'selesai' || p.status.toLowerCase() == 'completed').length;
    final tunda = projects.where((p) => p.status.toLowerCase() == 'tunda' || p.status.toLowerCase() == 'paused').length;
    final batal = projects.where((p) => p.status.toLowerCase() == 'batal' || p.status.toLowerCase() == 'cancelled').length;
  ...
  Widget _buildBody(ProjectController controller) {
