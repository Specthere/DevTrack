...
class _TambahMandorState extends State<TambahMandor> {
  ...
  void _onSubmit() async {
    if (_formKey.currentState!.validate()) {
      try {
        await _usersController.createMandor(_selectedImage);

        if (_usersController.isSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Akun mandor berhasil ditambahkan!'),
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                _usersController.errorMessage ?? 'Gagal menambahkan mandor',
              ),
