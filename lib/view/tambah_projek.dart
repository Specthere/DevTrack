...
class _TambahProjekState extends State<TambahProjek> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      _projectController.setDeadline(picked);
    }
  }
  ...
  Widget _buildProjectTitleField() {
    return TextFormField(
      controller: _projectController.namaProjectController,
  ...
  Widget _buildStatusDropdown() {
    return DropdownButtonFormField<String>(
      value:
          _projectController.statusController.text.isNotEmpty
      ...
      onChanged: (value) {
        setState(() {
          _projectController.statusController.text = value!;
        });
      },
      decoration: InputDecoration(
        labelText: 'Status',
  ...
  Widget _buildLocationSection(double screenWidth) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        TextFormField(
          controller: _projectController.lokasiController,
          decoration: InputDecoration(
